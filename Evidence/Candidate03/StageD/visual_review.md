...
## Capture 4: supported-pose transition review

The separate [Capture 4 motion review](capture04_motion_review.md) records 153 consecutive inspected frames around the arm-loss freeze, intact-corpse freeze, re-hit/resume and second freeze. The visible physical arrangement is preserved without an obvious transition snap in those windows. It also records small remaining motion among unfrozen corpses and the final distinction between 64 awake, 16 naturally sleeping and 16 frozen bodies. [Exact capture hashes, windows and telemetry](capture04_motion_review.json) accompany that bounded finding; it is not an all-bodies-settled, user-approval, or fresh-package claim. Earlier failed captures above remain historical evidence.
